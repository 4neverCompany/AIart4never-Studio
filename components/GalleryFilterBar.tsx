      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div className="flex items-center gap-4 text-xs text-zinc-500">
          ...
          <button
            ...
            className="ml-2 inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[#ff7a18]/10 border border-[#ff7a18]/30 text-[11px] text-[#ff7a18] hover:bg-[#ff7a18]/20 transition-colors"
          >
          ...
          <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
            {selectedForBatch.size > 0 && (
              <>
                ...
                <button
                  ...
                  className="px-3 py-2 bg-[#ff7a18] hover:bg-[#ff9d4d] active:bg-[#e8650a] text-[#050505] rounded-xl text-xs font-semibold transition-colors flex items-center gap-2"
                >
                ...
                <div className="relative" ref={collectionMenuRef}>
                  <button
                    ...
                    className={`px-3 py-2 rounded-xl text-xs font-medium transition-colors flex items-center gap-2 border ${
                      collectionMenuOpen
                        ? 'bg-[#ff7a18]/10 text-[#ff7a18] border-[#ff7a18]/30'
                      ...
                      {collections.length > 0 && (
                        <>
                          ...
                          {collections.map((c) => (
                            ...
                            >
                              <FolderOpen className="w-3.5 h-3.5 text-[#ff7a18] shrink-0" />
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="bg-zinc-950 border border-zinc-800/60 rounded-xl px-3 py-2 text-xs text-zinc-300 focus:outline-none focus:ring-2 focus:ring-[#ff7a18]/30 cursor-pointer"
              >
        ...
        <div className="flex flex-wrap gap-3 pt-3 border-t border-zinc-800/60">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="bg-zinc-950 border border-zinc-800/60 rounded-xl px-3 py-1.5 text-xs text-zinc-300 focus:outline-none focus:ring-2 focus:ring-[#ff7a18]/30 cursor-pointer"
            >
          ...
          <div className="flex items-center gap-2 flex-1 min-w-[220px]">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full bg-zinc-950 border border-zinc-800/60 rounded-xl pl-8 pr-3 py-1.5 text-xs text-white placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-[#ff7a18]/30 transition-colors"
              />
            </div>
            {tagQuery && (
              <button
